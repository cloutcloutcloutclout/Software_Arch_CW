...
public class StreetfoodApplication implements CommandLineRunner {
    ...
    public StreetfoodApplication(ReviewRepository reviewRepository, AwardRepository awardRepository, PhotoRepository photoRepository, VendorRepository vendorRepository, TagRepository tagRepository) {
    ...
    public void run(String... args) throws Exception {
        ...
        tagRepository.save(localLegend);
        tagRepository.save(vegetarian);
