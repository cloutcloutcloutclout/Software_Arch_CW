...
public class VendorValidator implements Validator {
    ...
    public void validate(Object target, Errors errors) {
        ...
        Vendor existing = vendorRepository.findByName(vendor.getName());
        if (existing != null && existing.getId() != vendor.getId() ) {
            errors.rejectValue("name", "", "The vendor already exists.");
        }
    }
}
